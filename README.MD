...
> Discover more at: [https://www.hiveworkshop.com/threads/online-wc3-map-data-viewer.310774/](https://www.hiveworkshop.com/threads/online-wc3-map-data-viewer.310774/)
       ...
       "configurations": [
           {
               ...
               "name": "Main",
               "request": "launch",
               "mainClass": "com.linsmod.Main",
               "projectName": "wc3dataHost",
               "args": ["E:\\Workspace\\project\\war3\\data-wc3hostAssets"]
           }
       ]
   }
   ```
...
4. In bash
   ...
   ```bash
   java com.linsmod.Main E:\Workspace\project\war3\data-wc3hostAssets
   ```
