  ...
  render() {
    ...
    return (
      <div className={classNames("SearchBox", {"search-hidden": !show})} onKeyDown={this.onKeyDown}>
        ...
        <button disabled={!found} onClick={this.findPrev} title="Previous"><Icons.ChevronUpIcon/></button>
        <button disabled={!found} onClick={this.findNext} title="Next"><Icons.ChevronDownIcon/></button>
        <button onClick={this.hide} title="Close find bar"><Icons.Cross2Icon/></button>
      </div>
    );
  }
}
