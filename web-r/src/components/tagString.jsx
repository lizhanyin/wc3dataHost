export default function tagString(value, data) {
  ...
  const ColorGroup = (arr, color) => {
    const ColorGroupComponent = key => <span style={{color}} key={key}>{arr}</span>;
    ColorGroupComponent.displayName = 'ColorGroupComponent';
    return ColorGroupComponent;
  }
