          ...
          <Navbar.Form pullLeft>
            <FormGroup>
              <div className="form-control">
                ...
                <button disabled={!results} onClick={this.findPrev} title="Previous"><FontAwesomeIcon icon={faChevronUp} /></button>
                <button disabled={!results} onClick={this.findNext} title="Next"><FontAwesomeIcon icon={faChevronDown} /></button>
              </div>
            </FormGroup>
          </Navbar.Form>
        </Navbar>
