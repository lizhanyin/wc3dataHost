...
const RawNames = React.createContext(false);
const SortNames = React.createContext(true);
const BuildCtx = React.createContext(0);
const TypeCtx = React.createContext('');
const IdCtx = React.createContext('');
const RawNamesSwitch = React.createContext(undefined); 
...
const getString = (object, col, index=-1) => {
...
const listObjectData = (object, data, rawNames, callback) => {
