...
function scrollView(Component, params) {
  ...
  const WrappedComponent = props => <Route render={({location: {hash}, history}) => <ScrollView {...props} {...{[$hash]: hash, [$history]: history}}/>}/>;
  WrappedComponent.displayName = ScrollView.displayName;
